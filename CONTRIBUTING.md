...
This outlines how to propose a change to fcmconfr. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("bhroston/fcmconfr", fork = TRUE)`.
...
Please note that the fcmconfr project is released with a [Contributor
Code of
Conduct](https://bhroston.github.io/fcmconfr/CODE_OF_CONDUCT.md). By
contributing to this project you agree to abide by its terms.

## Life Cycle Statement

This package is in an initially stable state of development, with a
great deal of subsequent development envisioned.
